    ...
    <div className="min-h-screen pt-28 pb-20 bg-[#0a0a0a] animate-fadeIn overflow-hidden">
      ...
      <section className="relative max-w-7xl mx-auto px-4 md:px-12 lg:px-24 mb-32">
        ...
        <div className="flex flex-col items-center text-center z-10 relative">
          <div className="relative group mb-10">
            <div className="absolute -inset-4 bg-red-600/30 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition duration-1000"></div>
            <img 
              src={LOGO_URL} 
              alt="Crimson Rift Studio" 
              className="relative w-full max-w-[200px] md:max-w-[280px] mx-auto drop-shadow-[0_0_40px_rgba(220,38,38,0.3)] animate-[pulse_4s_ease-in-out_infinite]" 
            />
          </div>
          
          <h2 className="text-sm font-bold text-red-600 tracking-[0.3em] uppercase mb-4">Di Balik Layar</h2>
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white tracking-tight mb-8 leading-tight">
            Mendobrak Batas <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-800">Kreativitas Digital.</span>
          </h1>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-12 lg:px-24 mb-32 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="order-2 lg:order-1 relative">
            ...
            <div className="bg-[#111] border border-gray-800 p-8 md:p-12 rounded-3xl relative z-10 shadow-2xl">
              <Crosshair className="text-red-600 w-12 h-12 mb-6" />
          ...
          <div className="order-1 lg:order-2 flex flex-col justify-center">
            <h2 className="text-red-600 font-bold tracking-widest uppercase text-sm mb-3">Cerita Kami</h2>
      ...
      <section className="bg-[#050505] py-32 border-y border-gray-900 relative">
        <div className="max-w-7xl mx-auto px-4 md:px-12 lg:px-24">
          <div className="text-center mb-20">
            <h2 className="text-red-600 font-bold tracking-widest uppercase text-sm mb-3">Identitas & Makna</h2>
            <h3 className="text-3xl md:text-5xl font-bold text-white">Filosofi <span className="text-red-600">Crimson Rift</span></h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="bg-[#0a0a0a] p-10 rounded-3xl border border-gray-800 hover:border-red-900/50 transition-colors group relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-red-600/10 rounded-bl-full -z-10 group-hover:bg-red-600/20 transition-colors"></div>
              <Flame className="text-red-600 w-12 h-12 mb-6" />
            ...
            <div className="bg-[#0a0a0a] p-10 rounded-3xl border border-gray-800 hover:border-red-900/50 transition-colors group relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-red-600/10 rounded-bl-full -z-10 group-hover:bg-red-600/20 transition-colors"></div>
              <Zap className="text-red-600 w-12 h-12 mb-6" />
          ...
          {/* Logo Philosophy */}
          <div className="bg-gradient-to-br from-[#111] to-[#0a0a0a] p-8 md:p-16 rounded-3xl border border-red-900/30 flex flex-col md:flex-row items-center gap-12 relative overflow-hidden shadow-[0_0_50px_rgba(220,38,38,0.05)]">
            <div className="absolute -left-20 top-1/2 -translate-y-1/2 w-64 h-64 bg-red-600/10 blur-3xl rounded-full"></div>
            <div className="md:w-1/3 flex justify-center relative z-10">
              <img 
                src={LOGO_URL} 
                alt="Logo Crimson Rift" 
                className="w-32 md:w-48 relative z-10 drop-shadow-[0_0_40px_rgba(220,38,38,0.4)]" 
              />
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-12 lg:px-24 py-32">
        <div className="text-center mb-16">
          <h2 className="text-red-600 font-bold tracking-widest uppercase text-sm mb-3">Nilai Inti Kami</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={idx} className="bg-[#111] p-10 rounded-2xl border border-gray-800 text-center hover:-translate-y-2 transition-transform duration-300">
              <div className="w-16 h-16 bg-[#0a0a0a] border border-gray-800 rounded-xl flex items-center justify-center text-red-600 mx-auto mb-6 shadow-lg shadow-red-900/20">
                {val.icon}
              </div>
      ...
      <section className="max-w-5xl mx-auto px-4 pb-12">
        <div className="bg-gradient-to-r from-red-900/40 to-[#111] border border-red-900/50 p-12 rounded-3xl text-center relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10">
            ...
            <a 
              ...
              className="inline-flex px-8 py-4 bg-red-600 hover:bg-red-700 text-white font-bold rounded-lg transition-all items-center justify-center gap-3 shadow-[0_0_30px_rgba(220,38,38,0.4)] hover:-translate-y-1"
            >
